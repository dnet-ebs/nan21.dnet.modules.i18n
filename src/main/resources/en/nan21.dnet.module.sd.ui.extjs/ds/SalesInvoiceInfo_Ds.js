Ext.define(Dnet.ns.sd + "SalesInvoiceInfo_Ds$Trl", {
	billToContactId__lbl: "Billing contact(ID)",
	billToContact__lbl: "Billing contact",
	billToLocationId__lbl: "Billing location(ID)",
	billToLocationRefId__lbl: "Billing location(Ref-ID)",
